...
A critical application of the phasor plot in the [pipeline](https://github.com/CreLox/FluorescenceLifetime/blob/master/Workflows/PhasorIntensityFiltersFLIMFitting.m) is to identify pixels with mostly autofluorescence, without performing tedious fitting pixel by pixel. Autofluorescent substances in the green channel in mammalian cells (see [Aubin, 1979](https://journals.sagepub.com/doi/epdf/10.1177/27.1.220325), [Morrow et al., 2022](https://www.biorxiv.org/content/10.1101/2022.12.14.520430v1), and [FPbase Fluorescence Spectra Viewer](https://www.fpbase.org/spectra/?s=4794,4795,4802,4803&showY=1&showX=1&showGrid=0&areaFill=0&logScale=0&scaleEC=0&scaleQY=0&shareTooltip=0&palette=wavelength)) typically feature shorter lifetimes (see [Horilova, Cunderlikova, and Chorvatova, 2014](https://www.spiedigitallibrary.org/journals/journal-of-biomedical-optics/volume-20/issue-05/051017/Time--and-spectrally-resolved-characteristics-of-flavin-fluorescence-in/10.1117/1.JBO.20.5.051017.full) and [Morrow et al., 2022](https://www.biorxiv.org/content/10.1101/2022.12.14.520430v1)) than the green fluorescent protein chosen for the FLIM experiment does. For example, in the [reference study](#how-to-cite-this-work), we used mNeonGreen (with a [reported lifetime](https://www.nature.com/articles/nmeth.2413) of ~ 3 ns) and [mScarlet-I](https://www.nature.com/articles/nmeth.4074) as the donor and the acceptor fluorophores (based on [McCullock, MacLean, and Kammermeier, 2020](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0219886)), respectively. Reflected on the phasor plot, the phasor transforms of time-resolved emission data registered to pixels with mostly autofluorescence are well separated from those registered to pixels with mostly fluorescent proteins.
...
[As a side note, Leica uses the sum of a continous spectrum of exponential decays for FLIM fitting, which is not implemented here. Related info can be found in [James and Ware, 1986](https://www.sciencedirect.com/science/article/pii/0009261486851077) and [Merola, Rigler, Holmgren, and Brochon, 1989](https://pubs.acs.org/doi/abs/10.1021/bi00434a038).]
