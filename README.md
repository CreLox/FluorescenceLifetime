...
<p align="center">
  ...
  The scatter plots show the mean FLIM data of mNeonGreen (red: NUP50-mNeonGreen-mScarlet-I; black: NUP50-mNeonGreen) and each error bar represents the standard deviation of each microtime bin (the number of cells $N = 3$ in each group).
</p>
